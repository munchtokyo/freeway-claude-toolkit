...
description: "MEMORY.md棚卸し・パターン昇格・スキル抽出。「メモリ整理」「MEMORY棚卸し」「メモリ健康診断」「パターン昇格」で発動。Curate auto-memory into durable knowledge: analyze, promote to CLAUDE.md/rules/, extract into skills."
---
